...
dataset_name = "OHE_splitted_sequences_50k_1"
seq_data = np.load("/alina-data1/Zara/TCell_Receptor/Embedding_Generation/" + dataset_name + ".npy")
attribute_data = np.loadtxt("/alina-data1/Zara/TCell_Receptor/Embedding_Generation/splitted_Labels_50k_1.npy", dtype=str)

#seq_data = []
#for i in range(len(data)):
#    seq_data.append(np.concatenate((data[i],all_embeddings[i])))
